...
*/
package trace // import "github.com/detunized/golang-x-net/trace"
...
import (
	...
	"github.com/detunized/golang-x-net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"github.com/detunized/golang-x-net/trace in your binary, trying to maintain separate state. This may " +
			"involve a vendored copy of github.com/detunized/golang-x-net/trace.")
	}
...
var contextKey = contextKeyT("github.com/detunized/golang-x-net/trace.Trace")
